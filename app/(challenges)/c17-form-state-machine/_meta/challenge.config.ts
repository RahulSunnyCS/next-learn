// ─── challenge.config.ts — C17 Client Form State-Machine ─────────────────────
//
...
// limitations in Turbopack.  This file exists so challenge code that needs
// typed access can `import config from './_meta/challenge.config'` and get
// the full ChallengeConfig type.
